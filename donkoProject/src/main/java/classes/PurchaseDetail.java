...
public class PurchaseDetail {
	...
	//購入詳細を追加する
	public static void addPurchaseDetail(ArrayList<PurchaseDetailBean> purchaseDetaiBeanList){
		InsertPurchaseDetail.insertPurchaseDetail(purchaseDetaiBeanList);
	};
