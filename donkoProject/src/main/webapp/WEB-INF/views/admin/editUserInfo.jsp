			...
			<form action="editUserInfo" method="post" style="display: flex; justify-content: center; margin: 30px;">
				<div class="col-lg-5 m-5" style="border: 1px solid #333333; padding: 65px;">
					<div class="cancelButton" style="display: flex; justify-content: space-between; margin-bottom: 20px;">
						...
						<div>
							<a href="myPage" style="text-decoration: none; text-align: center;">
					...
					<div class="form-group" style="display: flex; justify-content: center; margin-bottom: 30px;">
						<input type="text" class="form-control" id="exampleInputUserId" aria-describedby="userId" name="user_login_id" value="<%=users.getUserLoginId()%>">
					</div>
					<div style="margin-bottom: 10px;">
					...
					<div class="form-group" style="display: flex; justify-content: center; margin-bottom: 30px;">
						<input type="text" class="form-control" id="exampleInputUserName" aria-describedby="userName" name="user_name" value="<%=users.getUserName()%>">
					</div>
					<div style="margin-bottom: 10px;">
					...
					<div class="btn-toolbar mb-3" role="toolbar" aria-label="Toolbar with button groups">
						...
						<input type="checkbox" class="btn-check" id="change" autocomplete="off" name="password_checked" value="changed">
							<label class="btn btn-secondary me-2" for="change">
								change
							</label>
						<div class="input-group">
							<input type="text" class="form-control" id="exampleInputPassword" aria-label="Input group example" aria-describedby="btnGroupAddon" maxlength="8" name="password" style="display:none;">
						</div>
					</div>
					<div style="margin-bottom: 10px;">
					...
					<div class="form-group" style="display: flex; justify-content: center; margin-bottom: 70px;">
						<input type="date" class="form-control" id="exampleInputbirthday" name="birthday" value="<%=users.getBirthday()%>">
					</div>
