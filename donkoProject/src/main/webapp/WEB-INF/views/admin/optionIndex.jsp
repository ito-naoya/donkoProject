	...
	<body>
		<main>
			<div class="container">
				...
				<% } %>
				<button type="button" class="btn px-3 m-3" data-bs-toggle="modal" data-bs-target="#modalOptionAdd" style="background-color: #E5CCFF; color: black; border-radius: 2rem;">オプションを追加</button>
				<div class="row">
					<div class="col-6">
					<%
			      ...
			      <div class="modal-body">
			        <!-- フォーム内容 -->
			         <form action="editOption" method="post" >
						...
						<input type="text" class="form-control" id="newOptionName" name="newOptionName" maxlength="20" required value="" >
				      </div>
			...
			<!-- ポップアップ２：オプション詳細を追加 -->
			<div class="modal fade" id="modalOptionAdd2" tabindex="-1" aria-labelledby="modalLabel" aria-hidden="true">
			  <div class="modal-dialog modal-dialog-centered" style="max-width: 25%;">
			    <div class="modal-content">
			      <div class="modal-header">
			      ...
			      <div class="modal-body">
			        ...
			        <form action="editOptionDeteal" method="post" >
				        <label for="newOptionValue" class="form-label"  style="font-size: small; color: grey;">20文字以内</label>
						<input type="text" class="form-control" id="newOptionValue" name="newOptionValue" maxlength="20" required value="" >
						<input type="hidden" name="currentOptionCategoryName" value="<%= optionCategoryName %>" >
				      </div>
				      <div class="modal-footer">
				        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">キャンセル</button>
				        <button type="submit" class="btn btn-success">追加</button>
