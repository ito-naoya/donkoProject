...
<main class="m-5">
		<div class="container　ml-5 mr-5">
			<div class="row d-flex justify-content-center">
				<div class="col-lg-10 border p-5" style="border-radius:5px; box-shadow:10px 10px 10px lightgray;">
					<div class="row d-flex justify-content-center">
									...
									%>
										...
										%>
											...
											%>
												...
												<!-- チェックボックス -->
									            <div id="sizeCheck"">
									                <label for="optionBox_2" class="form-label mb-3 mt-3">オプション項目：<%= optionCategoryName %></label>
									                <br>
									                <% for (OptionCategoryBean option : optionCategoryList) {
