	...
	<main class="m-5">
		<div class="container">
			...
			<div class="row d-flex justify-content-center">
				<div class="col-lg-10">
					<a href="<%= url %>" class="arrow mb-3" style="display: inline-block; color:#385A37;">
					...
					<div class="d-flex justify-content-start mb-3">
						...
						%>
							...
							%>
								...
								%>
										<a href="itemDetail?itemId=<%=itemBean.getItemId()%>&source=<%= source %><%= categoryName != null ? "&categoryName=" + categoryName : "" %>" class="me-3" style="text-decoration: none; border:3px solid #ffffff; border-radius: 5px;">
