...
<body>
	...
	<main class="container">
		...
		<div class="AddressChoice"
			...
			<select class="form-control"style="width:400px;"  >
				<option hidden>デフォルト住所選択</option>
    ...
    (ArrayList<ShippingAddressBean>)request.getAttribute("shippingAddressList");%>
       <% for (ShippingAddressBean shippingAddressBean : shippingAddressList) { %> --%>
				<tr>
					<!-- 配送先ID -->
					<td style="width:5%;"><a href='editShippingAddress'>1</a>
          <%--
            TODO: あとで書き換え		
            <td><a href='editShippingAddress?=<%= shippingAddressBean.getShippingAddressId() %>'>1</a> 
          --%>
					</td>
					<!-- 郵便番号 -->
				  <td style="width:15%;">123-9876</td>
          <%--
            TODO: あとで書き換え 
            <td><%= shippingAddressBean.getPostalCode()%></td>
          --%>
					<!-- 住所 -->
					<td>大阪府守口市あいうえお町z-z-z</td>
           <%-- 
            TODO: あとで書き換え	
          ...
          <!-- 更新ボタン -->
					...
					<a href="editShippingAddress"
          style="color: #000000; text-decoration: none;">編集</a>
          <%--  
            TODO: あとで書き換え 
            <button type="submit" style="border: 1px solid #000000; background: #E5CCFF;">
