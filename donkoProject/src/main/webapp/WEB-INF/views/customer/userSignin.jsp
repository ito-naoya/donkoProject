				...
				<div class="col-5 p-5 border" style="border-radius: 10px;">
					...
					<div class="form-group"
						...
						<input type="password" class="form-control"
							id="exampleInputPassword" maxlength="8" value="">
					</div>
					<div class="cancelButton"
					...
					<div style="text-align: center; margin-bottom: 20px;">
						...
						<div>
							<a href="login"
								...
								<button type="button" class="btn btn-primary" aria-label="Login"
									style="background-color: #9933FF;">ログイン</button>
							</a>
						</div>
						...
						<div style="margin-top: 20px;">
							<a href="registration"
								style="text-decoration: none; text-align: center;">
								<button type="button" class="btn btn-primary" aria-label="Back"
									style="background-color: #9933FF;">新規登録画面へ戻る</button>
							</a>
						</div>
					</div>
				</div>
