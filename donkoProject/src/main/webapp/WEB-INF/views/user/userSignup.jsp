		...
		<div class="container　ml-5 mr-5">
			<div class="row justify-content-center">
				...
				<div class="col-5 p-5 border" style="border-radius:10px;">
						...
						<br>
						<!-- ここからフォーム -->
					    <form action="userSignup" method="post" onsubmit="return validatePassword()">
				            <div class="row my-3">
				              <label for="userLoginId" class="form-label">ユーザーID</label>
				              <label for="itemName" class="form-label"  style="font-size: small; color: grey;">5文字以上10文字以内</label>
				              <div class="col-12">
				            ...
				            <div class="row mb-4">
				              ...
				              <label for="itemName" class="form-label"  style="font-size: small; color: grey;">1文字以上25文字以内</label>
				              <div class="col-12">
				            ...
				            <div class="row mb-3">
				              ...
				              <label for="itemName" class="form-label" style="font-size: small; color: grey;">・半角英数字8文字以上16文字以内</label>
				              <label for="itemName" class="form-label" style="font-size: small; color: grey;">・数字を1つ以上含む</label>
				              <div class="col-12">
